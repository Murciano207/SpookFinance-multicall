...
function all(provider, multicallAddress, calls, block) {
    return __awaiter(this, void 0, void 0, function () {
        var multicall, callRequests, overrides, response, callCount, callResult, i, outputs, returnData, params, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, multicall.aggregate(callRequests, overrides)];
                case 1:
                    response = _a.sent();
